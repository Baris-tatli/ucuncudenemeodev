...
namespace OkulProje
{
    public partial class OgrenciDersPanel : Form
    {
        ...
        void listele()
        {
            dataGridView1.DataSource = (from x in db.odev_ogrenciders
                                        select new
                                        {
                                            x.ogrenciders_id,
                                            x.odev_ders.ders_ad,
                                            x.odev_ogrenci.ogrenci_fullname
            ...
            var derslist = db.odev_ders.ToList();
        ...
        {
            listele();
            var ogrenciler = (from x in db.odev_ogrenci
                               select new
                               {
                                   x.ogrenci_id,
                                   x.ogrenci_fullname
            ...
            var dersler = (from x in db.odev_ders
                              select new
                              {
                                  x.ders_id,
                                  x.ders_ad
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (sor == DialogResult.Yes)
            {
                ...
                var ogrencidersbul = db.odev_ogrenciders.Find(ogrencidersID);
                db.odev_ogrenciders.Remove(ogrencidersbul);
                db.SaveChanges();
        ...
        {
            odev_ogrenciders ekle = new odev_ogrenciders();
            ...
            {
                {
                    ...
                    var sonuc = (from x in db.odev_ogrenciders
                                 where x.odev_ogrenci.ogrenci_fullname.Contains(arama)
                                 select new
                                 {
                                     x.ogrenciders_id,
                                     x.odev_ders.ders_ad,
