...
namespace OkulProje
{
    public partial class DersPaneli : Form
    {
        ...
        void listele()
        {
            dataGridView1.DataSource = (from x in db.odev_ders
                                        select new
                                        {
                                            x.ders_id,
                                            x.ders_ad,
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (sor == DialogResult.Yes)
            {
                ...
                var dersbul = db.odev_ders.Find(DersID);
                db.odev_ders.Remove(dersbul);
                db.SaveChanges();
        ...
        private void btnguncelle_Click(object sender, EventArgs e)
        {
            ...
            var guncelle = db.odev_ders.Find(DersID);
